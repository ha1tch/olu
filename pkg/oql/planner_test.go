...
func (m *mockQueryableStore) Save(_ context.Context, _ string, _ int, _ map[string]interface{}) error {
	return nil
}
...
func (m *mockPlainStore) Save(_ context.Context, _ string, _ int, _ map[string]interface{}) error {
	return nil
}
