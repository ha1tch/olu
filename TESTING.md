...
> Auto-generated by `release.sh` on 2026-03-03 for v0.9.4.
...
Version **0.9.4**, generated 2026-03-03.

| Metric | Count |
|--------|-------|
| Tests (including subtests) | 1835 |
| Top-level tests | 974 |
| Passed | 955 |
| Skipped | 19 |
| Failed | 0 |
| Packages | 16 |
| Benchmark functions | 148 |
| Aggregate coverage | 77.6% |

## Package Breakdown

| Package | Tests (incl. subtests) | Skipped | Coverage |
|---------|----------------------:|--------:|---------:|
| `pkg/errors` | 4 | 0 | 100.0% |
| `pkg/version` | 1 | 0 | n/a |
| `pkg/models` | 20 | 0 | 95.8% |
| `pkg/config` | 102 | 0 | 83.1% |
| `pkg/tenant` | 39 | 0 | 96.9% |
| `pkg/validation` | 36 | 0 | 82.4% |
| `pkg/cache` | 34 | 7 | 67.0% |
| `pkg/middleware` | 26 | 0 | 85.8% |
| `pkg/jsonic` | 78 | 0 | 78.2% |
| `pkg/graph` | 50 | 0 | 82.2% |
| `pkg/sulpher` | 69 | 0 | 80.9% |
| `pkg/oql` | 452 | 3 | 79.9% |
| `pkg/storage` | 317 | 5 | 72.1% |
| `pkg/timeseries` | 86 | 4 | 75.5% |
| `pkg/server` | 507 | 0 | 74.6% |
